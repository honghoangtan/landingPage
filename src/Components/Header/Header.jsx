...
function Header() {
    ...
    return ( 
        <div className="sticky bg-white top-0 h-[90px] shadow-xl z-30">
            <div className="container mx-auto flex justify-between h-full items-center">
                ...
                <nav>
                    ...
                    <div 
                        ...
                        onClick={() => handleShow()}    
                    >
                        <i className="ri-menu-2-line text-4xl text-primary"></i>
                    </div>

                    <div className={isShow? '' : ''  && ''}></div>

                    <ul className={`${isShow ? 'h-[350px] p-6' : 'h-0 p-0'} fixed w-full bg-white overflow-hidden border-t top-[90px] left-0 right-0 flex flex-col
                    gap-4 lg:relative lg:flex-row lg:p-0 lg:top-0 lg:border-none lg:h-full transition-all duration-300`}>
                        <li>
                            <a href="#">Home</a> 
                        </li>
                        <li>
