        ...
        <div className="w-[40rem] rounded-md bg-white p-16">
            <div className="flex gap-2">
                <div className="relative grow">
                    <input type="text" id="first_name" className="pl-8 bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for part-time job" required />
                ...
                <div>
                    <button className="rounded-md bg-blue-500 px-4 py-2 text-white hover:bg-blue-700 flex items-center">
            ...
            <div className="mt-8 grid grid-cols-4 gap-4">
                ...
                { listJob.map((item, index) => {
                    return (
                        <Job key={index} bgColor={item.bgColor} icon={item.icon} title={item.title} />
                    )
                })}
