...
function JobCards() {  
    ...
    const positions = [
        {
            title: 'Design',
            open: '4',
            gradient: 'from-[#bbcbdb] to-[#f1d4ff]',
            icon: (
...

        {
            title: 'Engineering',
            open: '8',
            gradient: 'from-[#fbbbda] to-[#ffd4d4]',
            icon: (
                <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...

        {
            title: 'Operations',
            open: '2',
            gradient: 'from-[#bbebfb] to-[#efd4ff]',
            icon: (
    ...
    return ( 
      <div className="w-full text-center p-16">
            <h1 className="font-bold text-2xl mb-12">Open positions</h1>

            <div className="grid grid-cols-3 gap-6">
                { positions.map((item, index) => {
                    return (
                        <div key={index} className="flex flex-col bg-white rounded-2xl px-10 py-12 ">
                            <div className="flex items-center justify-center mb-3 space-x-4">
                                <div className={`w-12 h-12 rounded-2xl flex justify-center items-center bg-gradient-to-br ${item.gradient}`}>
                            ...
                            <button className="border-[1px] rounded-md px-6 py-4 text-lg hover:bg-[#1e2246] hover:text-white">
                                {item.open} open positions
                            </button>
                        </div>
                    )
                })}
            ...
            <p className="mx-auto max-w-3xl text-balance mt-12">
                We are proud to be an equal opportunity employer that values diversity. We do not discriminate on the
